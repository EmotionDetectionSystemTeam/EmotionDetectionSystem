...
export const ServerGetClass = async (id: number): Promise<Class> => {
  ...
  const students: Student[] = [
    new Student(1, "Alice", [
      ...
      new Emotion("Excited", new Date("2023-05-25T10:15:00")),
      ...
      new Emotion("Excited", new Date("2023-05-25T10:35:00")),
      new Emotion("Neutral", new Date("2023-05-25T10:40:00")),
      new Emotion("Sad", new Date("2023-05-25T10:45:00")),
    ]),
    new Student(2, "Bob", [
      new Emotion("Happy", new Date("2023-05-25T10:00:00")),
      new Emotion("Excited", new Date("2023-05-25T10:05:00")),
      ...
      new Emotion("Excited", new Date("2023-05-25T10:25:00")),
      ...
      new Emotion("Excited", new Date("2023-05-25T10:45:00")),
    ]),
    new Student(3, "Charlie", [
      ...
      new Emotion("Excited", new Date("2023-05-25T10:30:00")),
      new Emotion("Neutral", new Date("2023-05-25T10:35:00")),
